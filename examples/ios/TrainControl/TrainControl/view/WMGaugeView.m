...
- (NSInteger) innerBackgroundStyleNum {
	return _innerBackgroundStyle;
}
- (void) setInnerBackgroundStyleNum: (NSInteger) value {
	_innerBackgroundStyle = value;
    [self invalidateBackground];
}
- (NSInteger) needleStyleNum {
	return _needleStyle;
}
- (void) setNeedleStyleNum: (NSInteger) value {
	_needleStyle = value;
    [self invalidateNeedle];
}
- (NSInteger) needleScrewStyleNum {
	return _needleScrewStyle;
}
- (void) setNeedleScrewStyleNum: (NSInteger) value {
	_needleScrewStyle = value;
    [self invalidateNeedle];
}
...
- (void)setScaleIgnoreRangeColors:(BOOL)scaleIgnoreRangeColors
{
	_scaleIgnoreRangeColors = scaleIgnoreRangeColors;
    [self invalidateBackground];
}
