...
public protocol BonjourDiscoveryDelegate: class {
	...
	func bonjourDiscovery(_ bonjourDiscovery: BonjourDiscovery, didFindService: NetService, atHosts host: [String])
	func bonjourDiscovery(_ bonjourDiscovery: BonjourDiscovery, didRemovedService: NetService)
...
public class BonjourDiscovery: NSObject {
